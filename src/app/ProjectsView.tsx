...
export function ProjectsView({
  ...
  const launcher = useProjectLauncher({
    ...
    notify,
    onProjectLaunched: projects.markProjectLaunched,
  });
  const model: ProjectsPageModel = {
    projects: projects.filteredProjects,
    totalProjects: projects.projects.length,
    totalVisibleProjects: projects.totalVisibleProjects,
    hasMoreProjects: projects.hasMoreProjects,
    search: projects.search,
    favoriteOnly: projects.favoriteOnly,
    sortKey: projects.sortKey,
    scanStatus: projects.scanStatus,
    scanError: projects.scanError,
    scan: projects.scan,
    ...
    onFavoriteOnly: projects.setFavoriteOnly,
    onSortKey: projects.setSortKey,
    onShowMoreProjects: projects.showMoreProjects,
    onToggleFavorite: (project) => void projects.toggleFavorite(project),
