...
pub const UI_MESSAGE_KEYS: &[&str] = &[
    ...
    "action-check-winboat-settings",
    "dismiss-notification",
    "generic-action-failed",
    "unknown-error",
    "toast-windows-started",
    "toast-windows-started-detail",
    "toast-winboat-setup-opened",
    "toast-winboat-setup-opened-detail",
    "toast-winboat-setup-complete",
    "toast-winboat-setup-complete-reconnected",
    "toast-studio-opened",
    ...
    "studio-eyebrow",
    "studio-description",
    "offline-guidance-title",
    "offline-guidance-detail",
    "winboat-missing-title",
    "winboat-missing-detail",
    "winboat-setup-required-title",
    "winboat-setup-required-detail",
    "winboat-setup-pending-title",
    "winboat-setup-pending-detail",
    "windows-preparing-title",
    "windows-preparing-detail",
    "installed-title",
    "installed-meta",
    "refresh-installed",
    "action-launching",
    ...
    "action-open-folder",
    "projects-found",
    "projects-manifest-meta",
    "project-column-name",
    "project-column-version",
    "project-column-modified",
    ...
    "settings-route-aria",
    "settings-step-winboat",
    "settings-step-workspace",
    "settings-step-environment",
    "settings-step-cargo",
